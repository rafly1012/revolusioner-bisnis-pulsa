...
/**
* @see \App\Http\Controllers\Admin\ProductsController::index
* @see app/Http/Controllers/Admin/ProductsController.php:20
...
/**
* @see \App\Http\Controllers\Admin\ProductsController::create
* @see app/Http/Controllers/Admin/ProductsController.php:30
...
/**
* @see \App\Http\Controllers\Admin\ProductsController::store
* @see app/Http/Controllers/Admin/ProductsController.php:38
* @route '/admin/products'
*/
...
/**
* @see \App\Http\Controllers\Admin\ProductsController::show
* @see app/Http/Controllers/Admin/ProductsController.php:64
...
/**
* @see \App\Http\Controllers\Admin\ProductsController::edit
* @see app/Http/Controllers/Admin/ProductsController.php:72
...
/**
* @see \App\Http\Controllers\Admin\ProductsController::update
* @see app/Http/Controllers/Admin/ProductsController.php:82
* @route '/admin/products/{product}'
*/
...
/**
* @see \App\Http\Controllers\Admin\ProductsController::destroy
* @see app/Http/Controllers/Admin/ProductsController.php:112
* @route '/admin/products/{product}'
*/
...
const ProductsController = { index, create, store, show, edit, update, destroy }
