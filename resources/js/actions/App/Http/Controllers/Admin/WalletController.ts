...
/**
* @see \App\Http\Controllers\Admin\WalletController::update
* @see app/Http/Controllers/Admin/WalletController.php:14
* @route '/admin/wallets/{user}/wallet'
*/
